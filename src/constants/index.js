...
export const HOVERED_ITEM = 'HOVERED_ITEM'
export const CLEAR_HOVERED_ITEM = 'CLEAR_HOVERED_ITEM'
export const INSERT_TALENT_TO_BUILD = 'INSERT_TALENT_TO_BUILD'
...
export const TOGGLE_ADD_ARCANA_OPEN = 'TOGGLE_ADD_ARCANA_OPEN'
export const ADD_NOTES = 'ADD_NOTES'
export const SELECTED_ARCANA = 'SELECTED_ARCANA'
export const HOVERED_ARCANA = 'HOVERED_ARCANA'
export const CLEAR_HOVERED_ARCANA = 'CLEAR_HOVERED_ARCANA'
export const INSERT_ARCANA_TO_BUILD = 'INSERT_ARCANA_TO_BUILD'
export const REMOVE_ARCANA_FROM_BUILD = 'REMOVE_ARCANA_FROM_BUILD'
export const SET_EDIT_BUILD = 'SET_EDIT_BUILD'
